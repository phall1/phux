...
- **Scope.** Satellite-targeted `SPAWN_TERMINAL` addressing and predictive-echo
  tuning across the extra hop are defined separately. `ROUTE_INPUT` remains
  the attach-free input path through a hub (lease-gated as above).
