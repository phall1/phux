...
Generated 2026-07-15T18:35:39Z by the ci-metrics workflow. Do not edit —
...
|---|---:|---:|---:|---:|
| test | 111 | 2s | 13m04s | 16m55s |
| check | 110 | 2s | 2m36s | 4m26s |
| detect docs-only | 112 | 2s | 5s | 7s |
...
|---|---|---:|---:|
| ci / check | clippy | 2m08s | 53 |
| ci / check | doc | 14s | 53 |
| ci / check | deny | 3s | 53 |
| ci / check | fmt | 1s | 55 |
| ci / test | unit | 12m20s | 45 |
| ci / test | e2e | 9s | 44 |
...
## Slowest tests (latest instrumented run, `001892741`)

| test | wall |
|---|---:|
| `phux-server::perf_bursty_output::synthesize_against_reference_alloc_bounded_under_full_churn` | 90.570s |
| `phux-server::terminal_actor::tests::resize_desync_then_both_shrink_does_not_overflow` | 23.748s |
