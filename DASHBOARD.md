...
Generated 2026-07-15T20:09:59Z by the ci-metrics workflow. Do not edit —
...
|---|---:|---:|---:|---:|---:|
| ci | 138 | 60% | 13m29s | 17m15s | 1714 |
| observatory | 5 | 80% | 11m56s | 12m25s | 118 |
| stress | 6 | 50% | 6s | 21m33s | 65 |
| release-please | 21 | 100% | 42s | 54s | 28 |
| conventional-commits | 129 | 86% | 15s | 20s | 24 |

## ci jobs, last 30 days

| job | runs | median queue | median wall | p95 wall |
|---|---:|---:|---:|---:|
| test | 137 | 2s | 13m19s | 17m06s |
| check | 135 | 2s | 2m39s | 4m29s |
| detect docs-only | 138 | 2s | 5s | 7s |

## Slowest ci steps (median, last 30 days)

| job | step | median | samples |
|---|---|---:|---:|
| test | tests (unit + e2e) | 15m34s | 16 |
...
|---|---|---:|---:|
| ci / check | clippy | 2m01s | 72 |
| ci / check | doc | 14s | 72 |
| ci / check | deny | 4s | 72 |
| ci / check | fmt | 1s | 75 |
| ci / test | unit | 14m04s | 62 |
| ci / test | e2e | 9s | 61 |
| ci / test | agents-smoke | 1s | 2 |
...
## Slowest tests (latest instrumented run, `b7cfefef1`)

| test | wall |
|---|---:|
| `phux-server::perf_bursty_output::synthesize_against_reference_alloc_bounded_under_full_churn` | 87.648s |
| `phux-server::terminal_actor::tests::resize_desync_then_both_shrink_does_not_overflow` | 22.899s |
