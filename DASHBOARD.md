...
Generated 2026-07-15T20:05:17Z by the ci-metrics workflow. Do not edit —
...
|---|---:|---:|---:|---:|
| test | 136 | 2s | 13m19s | 17m06s |
| check | 134 | 2s | 2m37s | 4m29s |
| detect docs-only | 137 | 2s | 5s | 7s |
...
|---|---|---:|---:|
| ci / check | clippy | 2m02s | 71 |
| ci / check | doc | 14s | 71 |
| ci / check | deny | 4s | 71 |
| ci / check | fmt | 1s | 74 |
| ci / test | unit | 14m04s | 61 |
| ci / test | e2e | 9s | 60 |
...
## Slowest tests (latest instrumented run, `0484dcb98`)

| test | wall |
|---|---:|
| `phux-server::perf_bursty_output::synthesize_against_reference_alloc_bounded_under_full_churn` | 98.573s |
| `phux-server::terminal_actor::tests::resize_desync_then_both_shrink_does_not_overflow` | 24.384s |
