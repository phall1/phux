...
Generated 2026-07-27T14:17:58Z by the ci-metrics workflow. Do not edit —
...
|---|---:|---:|---:|---:|
| test | 248 | 2s | 13m26s | 17m46s |
| check | 246 | 2s | 3m15s | 5m11s |
| detect docs-only | 251 | 2s | 5s | 8s |

## Slowest ci steps (median, last 30 days)

| job | step | median | samples |
|---|---|---:|---:|
| test | tests (unit + e2e) | 13m40s | 16 |
| check | rust checks (fmt + clippy + doc + deny) | 3m06s | 16 |
| test | runner disk headroom | 55s | 18 |
...
| check | formula-check | 6s | 11 |
| check | e2e lane coverage | 5s | 11 |

## Cargo phases inside the lanes (median, last 30 days)

| workflow / job | phase | median | samples |
|---|---|---:|---:|
| ci / check | clippy | 1m55s | 135 |
| ci / check | doc | 11s | 135 |
| ci / check | deny | 4s | 134 |
| ci / check | fmt | 2s | 138 |
| ci / test | unit | 13m24s | 123 |
| ci / test | e2e | 10s | 122 |
| ci / test | agents-smoke | 1s | 63 |
...
## Slowest tests (latest instrumented run, `65a296b14`)

| test | wall |
|---|---:|
| `phux-server::perf_bursty_output::synthesize_against_reference_alloc_bounded_under_full_churn` | 87.467s |
| `phux-server::terminal_actor::tests::resize_desync_then_both_shrink_does_not_overflow` | 23.405s |
...
| `phux-record::golden_cast::both_containers_agree_on_the_frame_count_for_one_recording` | 3.111s |
