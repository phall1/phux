...
Generated 2026-07-15T09:39:39Z by the ci-metrics workflow. Do not edit —
...
|---|---:|---:|---:|---:|---:|
| ci | 48 | 67% | 13m36s | 16m52s | 657 |
| stress | 6 | 50% | 6s | 21m33s | 65 |
| observatory | 2 | 100% | 11m44s | 11m44s | 47 |
| release-please | 9 | 100% | 35s | 44s | 20 |
| conventional-commits | 32 | 94% | 16s | 19s | 6 |

## ci jobs, last 30 days

| job | runs | median queue | median wall | p95 wall |
|---|---:|---:|---:|---:|
| test | 47 | 2s | 13m25s | 16m41s |
| check | 46 | 2s | 2m37s | 4m22s |
| detect docs-only | 48 | 2s | 5s | 7s |
...
|---|---|---:|---:|
| ci / check | clippy | 2m08s | 15 |
| ci / check | doc | 14s | 15 |
| ci / check | deny | 3s | 15 |
| ci / check | fmt | 1s | 15 |
| ci / test | unit | 12m02s | 13 |
| ci / test | e2e | 8s | 12 |
...
## Slowest tests (latest instrumented run, `355716da3`)

| test | wall |
|---|---:|
| `phux-server::perf_bursty_output::synthesize_against_reference_alloc_bounded_under_full_churn` | 88.354s |
| `phux-server::terminal_actor::tests::resize_desync_then_both_shrink_does_not_overflow` | 23.250s |
