...
Generated 2026-07-26T02:17:00Z by the ci-metrics workflow. Do not edit —
...
|---|---:|---:|---:|---:|---:|
| ci | 220 | 58% | 13m29s | 18m14s | 2599 |
| stress | 20 | 65% | 18m05s | 23m45s | 257 |
| observatory | 10 | 80% | 12m07s | 12m56s | 215 |
| release-please | 41 | 98% | 44s | 7m03s | 78 |
| conventional-commits | 204 | 82% | 16s | 21s | 42 |

## ci jobs, last 30 days

| job | runs | median queue | median wall | p95 wall |
|---|---:|---:|---:|---:|
| test | 217 | 2s | 13m21s | 17m51s |
| check | 215 | 2s | 2m47s | 5m05s |
| detect docs-only | 220 | 2s | 5s | 7s |

## Slowest ci steps (median, last 30 days)

| job | step | median | samples |
|---|---|---:|---:|
| test | tests (unit + e2e) | 12m38s | 12 |
| check | rust checks (fmt + clippy + doc + deny) | 1m32s | 12 |
| check | runner disk headroom | 1m07s | 12 |
| test | runner disk headroom | 1m01s | 12 |
| test | Run Swatinem/rust-cache@v2 | 23s | 12 |
| check | Run Swatinem/rust-cache@v2 | 21s | 12 |
...
## Slowest tests (latest instrumented run, `20402d715`)

| test | wall |
|---|---:|
| `phux-server::perf_bursty_output::synthesize_against_reference_alloc_bounded_under_full_churn` | 112.904s |
| `phux-server::terminal_actor::tests::resize_desync_then_both_shrink_does_not_overflow` | 28.101s |
