...
Generated 2026-07-15T09:33:44Z by the ci-metrics workflow. Do not edit —
...
|---|---:|---:|---:|---:|
| test | 46 | 2s | 13m22s | 16m41s |
| check | 45 | 2s | 2m37s | 4m22s |
| detect docs-only | 47 | 2s | 5s | 7s |

## Slowest ci steps (median, last 30 days)

| job | step | median | samples |
|---|---|---:|---:|
| test | tests (unit + e2e) | 12m48s | 17 |
| check | rust checks (fmt + clippy + doc + deny) | 2m32s | 18 |
...
|---|---|---:|---:|
| ci / check | clippy | 1m59s | 14 |
| ci / check | doc | 14s | 14 |
| ci / check | deny | 3s | 14 |
| ci / check | fmt | 1s | 14 |
| ci / test | unit | 11m56s | 12 |
| ci / test | e2e | 8s | 11 |
...
## Slowest tests (latest instrumented run, `66dc4d09a`)

| test | wall |
|---|---:|
| `phux-server::perf_bursty_output::synthesize_against_reference_alloc_bounded_under_full_churn` | 112.840s |
