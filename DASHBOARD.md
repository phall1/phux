...
Generated 2026-07-15T20:35:34Z by the ci-metrics workflow. Do not edit —
...
|---|---:|---:|---:|---:|
| test | 141 | 2s | 13m19s | 17m06s |
| check | 139 | 2s | 2m39s | 4m29s |
| detect docs-only | 142 | 2s | 5s | 7s |

## Slowest ci steps (median, last 30 days)

| job | step | median | samples |
|---|---|---:|---:|
| test | tests (unit + e2e) | 15m34s | 15 |
...
|---|---|---:|---:|
| ci / check | clippy | 1m59s | 74 |
| ci / check | doc | 13s | 74 |
| ci / check | deny | 4s | 74 |
| ci / check | fmt | 1s | 77 |
| ci / test | unit | 14m03s | 64 |
| ci / test | e2e | 9s | 63 |
| ci / test | agents-smoke | 1s | 4 |
...
## Slowest tests (latest instrumented run, `87382fa7a`)

| test | wall |
|---|---:|
| `phux-server::perf_bursty_output::synthesize_against_reference_alloc_bounded_under_full_churn` | 83.111s |
| `phux-server::terminal_actor::tests::resize_desync_then_both_shrink_does_not_overflow` | 20.440s |
...
| `phux-server::agent_detect::detector_publishes_blocked_from_a_live_prompt_box` | 3.512s |
