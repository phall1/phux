...
|---|---:|---:|---:|---:|
| test | 116 | 2s | 13m18s | 17m02s |
| check | 115 | 2s | 2m36s | 4m26s |
| detect docs-only | 117 | 2s | 5s | 7s |
...
|---|---|---:|---:|
| ci / check | clippy | 2m02s | 58 |
| ci / check | doc | 14s | 58 |
| ci / check | deny | 3s | 58 |
| ci / check | fmt | 1s | 60 |
| ci / test | unit | 13m02s | 50 |
| ci / test | e2e | 9s | 49 |
...
## Slowest tests (latest instrumented run, `001ad15b3`)

| test | wall |
|---|---:|
| `phux-server::perf_bursty_output::synthesize_against_reference_alloc_bounded_under_full_churn` | 105.936s |
| `phux-server::terminal_actor::tests::resize_desync_then_both_shrink_does_not_overflow` | 28.212s |
