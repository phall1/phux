...
Generated 2026-08-02T06:06:03Z by the ci-metrics workflow. Do not edit —
...
|---|---:|---:|---:|---:|---:|
| ci | 324 | 57% | 13m25s | 18m27s | 3840 |
| observatory | 17 | 88% | 12m23s | 13m00s | 385 |
| stress | 35 | 43% | 5m20s | 22m37s | 325 |
| release-please | 69 | 99% | 45s | 7m37s | 170 |
| conventional-commits | 290 | 82% | 16s | 24s | 60 |

## ci jobs, last 30 days

| job | runs | median queue | median wall | p95 wall |
|---|---:|---:|---:|---:|
| test | 319 | 2s | 13m18s | 17m46s |
| check | 317 | 2s | 3m01s | 5m11s |
| detect docs-only | 321 | 2s | 5s | 8s |
...
| check | runner disk headroom | 5s | 16 |

## Cargo phases inside the lanes (median, last 30 days)

| workflow / job | phase | median | samples |
|---|---|---:|---:|
| ci / check | clippy | 1m49s | 176 |
| ci / check | doc | 10s | 176 |
| ci / check | deny | 3s | 175 |
| ci / check | fmt | 2s | 180 |
| ci / test | unit | 12m42s | 162 |
| ci / test | e2e | 11s | 159 |
| ci / test | agents-smoke | 1s | 99 |
...
## Slowest tests (latest instrumented run, `2b4eadcbb`)
...
| `phux-record::golden_cast::both_containers_agree_on_the_frame_count_for_one_recording` | 2.211s |
