...
Generated 2026-08-02T09:02:08Z by the ci-metrics workflow. Do not edit —
...
## Slowest tests (latest instrumented run, `72b12abde`)

| test | wall |
|---|---:|
| `phux-server::terminal_actor::tests::resize_desync_then_both_shrink_does_not_overflow` | 14.397s |
