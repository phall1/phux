...
Generated 2026-07-15T08:44:30Z by the ci-metrics workflow. Do not edit —
...
|---|---:|---:|---:|---:|
| test | 38 | 2s | 13m22s | 16m14s |
| check | 38 | 2s | 2m36s | 4m09s |
| detect docs-only | 39 | 2s | 5s | 7s |

## Slowest ci steps (median, last 30 days)

| job | step | median | samples |
|---|---|---:|---:|
| test | tests (unit + e2e) | 12m42s | 17 |
...
|---|---|---:|---:|
| ci / check | clippy | 40s | 8 |
| ci / check | doc | 14s | 8 |
| ci / check | deny | 3s | 8 |
| ci / check | fmt | 1s | 8 |
| ci / test | unit | 11m47s | 6 |
| ci / test | e2e | 9s | 6 |
...
## Slowest tests (latest instrumented run, `388177574`)

| test | wall |
|---|---:|
| `phux-server::perf_bursty_output::synthesize_against_reference_alloc_bounded_under_full_churn` | 108.302s |
| `phux-server::terminal_actor::tests::resize_desync_then_both_shrink_does_not_overflow` | 27.947s |
