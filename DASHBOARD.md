...
Generated 2026-08-03T03:06:10Z by the ci-metrics workflow. Do not edit —
...
|---|---:|---:|---:|---:|
| test | 393 | 2s | 11m20s | 17m30s |
| check | 392 | 2s | 2m35s | 5m05s |
| detect docs-only | 395 | 2s | 5s | 8s |

## Slowest ci steps (median, last 30 days)

| job | step | median | samples |
|---|---|---:|---:|
| test | tests (unit + e2e) | 11m31s | 13 |
| check | rust checks (fmt + clippy + doc + deny) | 3m00s | 16 |
...
|---|---|---:|---:|
| ci / check | clippy | 1m40s | 219 |
| ci / check | doc | 10s | 219 |
| ci / check | deny | 3s | 218 |
| ci / check | fmt | 2s | 225 |
| ci / test | unit | 12m11s | 203 |
| ci / test | e2e | 11s | 199 |
| ci / test | agents-smoke | 1s | 139 |
...
## Slowest tests (latest instrumented run, `19950c1fc`)

| test | wall |
|---|---:|
| `phux-server::terminal_actor::tests::resize_desync_then_both_shrink_does_not_overflow` | 4.014s |
| `phux-record::golden_cast::golden_cast_renders_gif_and_apng_and_frame_counts_agree` | 3.970s |
