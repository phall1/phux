...
Generated 2026-07-15T10:29:30Z by the ci-metrics workflow. Do not edit —
...
|---|---:|---:|---:|---:|---:|
| ci | 75 | 59% | 13m13s | 16m51s | 913 |
| stress | 6 | 50% | 6s | 21m33s | 65 |
| observatory | 2 | 100% | 11m44s | 11m44s | 47 |
| release-please | 13 | 100% | 37s | 48s | 23 |
| conventional-commits | 69 | 91% | 16s | 19s | 13 |

## ci jobs, last 30 days

| job | runs | median queue | median wall | p95 wall |
|---|---:|---:|---:|---:|
| test | 74 | 2s | 13m02s | 16m41s |
| check | 73 | 2s | 2m37s | 4m23s |
| detect docs-only | 75 | 2s | 5s | 7s |

## Slowest ci steps (median, last 30 days)

| job | step | median | samples |
|---|---|---:|---:|
| test | tests (unit + e2e) | 12m45s | 9 |
...
|---|---|---:|---:|
| ci / check | clippy | 1m59s | 30 |
| ci / check | doc | 14s | 30 |
| ci / check | deny | 3s | 30 |
| ci / check | fmt | 1s | 32 |
| ci / test | unit | 11m55s | 23 |
| ci / test | e2e | 8s | 22 |
...
## Slowest tests (latest instrumented run, `657a2bc92`)

| test | wall |
|---|---:|
| `phux-server::perf_bursty_output::synthesize_against_reference_alloc_bounded_under_full_churn` | 118.918s |
| `phux-server::terminal_actor::tests::resize_desync_then_both_shrink_does_not_overflow` | 27.970s |
