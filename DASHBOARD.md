...
Generated 2026-08-04T19:49:12Z by the ci-metrics workflow. Do not edit —
...
|---|---:|---:|---:|---:|
| test | 456 | 2s | 10m26s | 17m30s |
| check | 457 | 2s | 2m33s | 5m21s |
| detect docs-only | 460 | 2s | 5s | 9s |
...
| check | rust checks (fmt + clippy + doc + deny) | 4m31s | 18 |
