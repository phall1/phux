...
Generated 2026-07-15T05:08:22Z by the ci-metrics workflow. Do not edit —
...
|---|---:|---:|---:|---:|---:|
| ci | 38 | 66% | 13m29s | 16m29s | 499 |
| stress | 3 | 67% | 21m11s | 21m11s | 43 |
| observatory | 1 | 100% | 11m44s | 11m44s | 23 |
| conventional-commits | 21 | 90% | 16s | 19s | 4 |
| release-please | 7 | 100% | 21s | 37s | 3 |

## ci jobs, last 30 days

| job | runs | median queue | median wall | p95 wall |
|---|---:|---:|---:|---:|
| test | 37 | 2s | 13m22s | 15m56s |
| check | 37 | 2s | 2m36s | 4m09s |
| detect docs-only | 38 | 2s | 5s | 7s |
...
| check | rust checks (fmt + clippy + doc + deny) | 1m45s | 18 |
...
|---|---|---:|---:|
| ci / check | clippy | 40s | 7 |
| ci / check | doc | 14s | 7 |
| ci / check | deny | 3s | 7 |
| ci / check | fmt | 1s | 7 |
| ci / test | unit | 11m47s | 5 |
| ci / test | e2e | 9s | 5 |
...
## Slowest tests (latest instrumented run, `da869972e`)

| test | wall |
|---|---:|
| `phux-server::perf_bursty_output::synthesize_against_reference_alloc_bounded_under_full_churn` | 110.277s |
| `phux-server::terminal_actor::tests::resize_desync_then_both_shrink_does_not_overflow` | 28.899s |
...
| `phux-server::runtime::input_lane::tests::lane_routed_input_interleaves_with_a_large_pty_output_burst` | 2.097s |
