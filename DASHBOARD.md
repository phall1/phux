...
Generated 2026-08-02T05:08:49Z by the ci-metrics workflow. Do not edit —
...
## Slowest tests (latest instrumented run, `d57682ea6`)

| test | wall |
|---|---:|
| `phux-server::terminal_actor::tests::resize_desync_then_both_shrink_does_not_overflow` | 14.220s |
