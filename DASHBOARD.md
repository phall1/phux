...
Generated 2026-07-26T00:19:51Z by the ci-metrics workflow. Do not edit —
...
|---|---:|---:|---:|---:|---:|
| ci | 205 | 59% | 13m31s | 18m14s | 2469 |
| stress | 20 | 65% | 18m05s | 23m45s | 257 |
| observatory | 10 | 80% | 12m07s | 12m56s | 215 |
| release-please | 37 | 97% | 44s | 7m03s | 76 |
| conventional-commits | 188 | 83% | 16s | 21s | 40 |

## ci jobs, last 30 days

| job | runs | median queue | median wall | p95 wall |
|---|---:|---:|---:|---:|
| test | 203 | 2s | 13m21s | 17m51s |
| check | 201 | 2s | 2m47s | 5m11s |
| detect docs-only | 205 | 2s | 5s | 7s |
...
| check | rust checks (fmt + clippy + doc + deny) | 2m48s | 12 |
...
|---|---|---:|---:|
| ci / check | clippy | 1m59s | 106 |
| ci / check | doc | 11s | 106 |
| ci / check | deny | 4s | 106 |
| ci / check | fmt | 1s | 109 |
| ci / test | unit | 14m04s | 96 |
| ci / test | e2e | 10s | 95 |
| ci / test | agents-smoke | 1s | 36 |
...
## Slowest tests (latest instrumented run, `5acfdbbd9`)

| test | wall |
|---|---:|
| `phux-server::perf_bursty_output::synthesize_against_reference_alloc_bounded_under_full_churn` | 112.826s |
| `phux-server::terminal_actor::tests::resize_desync_then_both_shrink_does_not_overflow` | 28.195s |
