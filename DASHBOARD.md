...
Generated 2026-08-03T22:45:26Z by the ci-metrics workflow. Do not edit —
...
|---|---:|---:|---:|---:|
| test | 441 | 2s | 10m40s | 17m34s |
| check | 442 | 2s | 2m35s | 5m17s |
| detect docs-only | 445 | 2s | 5s | 8s |
...
| test | Run Swatinem/rust-cache@v2 | 12s | 18 |
...
|---|---|---:|---:|
| ci / check | clippy | 1m47s | 248 |
| ci / check | doc | 10s | 248 |
| ci / check | deny | 3s | 246 |
| ci / check | fmt | 2s | 255 |
...
## Slowest tests (latest instrumented run, `e33c51bd7`)

| test | wall |
|---|---:|
| `phux-record::golden_cast::golden_cast_renders_gif_and_apng_and_frame_counts_agree` | 3.990s |
| `phux-server::terminal_actor::tests::resize_desync_then_both_shrink_does_not_overflow` | 3.976s |
