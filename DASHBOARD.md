...
Generated 2026-08-01T10:23:41Z by the ci-metrics workflow. Do not edit —
...
|---|---:|---:|---:|---:|
| test | 261 | 2s | 13m26s | 17m51s |
| check | 259 | 2s | 3m16s | 5m14s |
| detect docs-only | 264 | 2s | 5s | 8s |
...
|---|---|---:|---:|
| ci / check | clippy | 1m55s | 144 |
| ci / check | doc | 11s | 144 |
| ci / check | deny | 4s | 143 |
| ci / check | fmt | 2s | 147 |
| ci / test | unit | 13m24s | 131 |
| ci / test | e2e | 10s | 128 |
...
## Slowest tests (latest instrumented run, `156544cca`)

| test | wall |
|---|---:|
| `phux-server::terminal_actor::tests::resize_desync_then_both_shrink_does_not_overflow` | 27.986s |
| `phux-server::hub_relay_federation::aggregated_list_merges_local_and_satellite_terminals_and_degrades` | 15.120s |
...
| `phux-record::golden_cast::both_containers_agree_on_the_frame_count_for_one_recording` | 3.725s |
...
| `phux-record::golden_cast::golden_cast_renders_to_an_animated_png` | 2.068s |
