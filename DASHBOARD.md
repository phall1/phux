...
Generated 2026-07-26T03:09:25Z by the ci-metrics workflow. Do not edit —
...
|---|---:|---:|---:|---:|
| test | 220 | 2s | 13m22s | 17m51s |
| check | 218 | 2s | 2m49s | 5m05s |
| detect docs-only | 223 | 2s | 5s | 7s |

## Slowest ci steps (median, last 30 days)

| job | step | median | samples |
|---|---|---:|---:|
| test | tests (unit + e2e) | 12m40s | 14 |
| check | rust checks (fmt + clippy + doc + deny) | 1m32s | 13 |
...
|---|---|---:|---:|
| ci / check | clippy | 1m53s | 116 |
| ci / check | doc | 11s | 116 |
| ci / check | deny | 4s | 116 |
| ci / check | fmt | 2s | 119 |
| ci / test | unit | 13m52s | 106 |
| ci / test | e2e | 10s | 105 |
| ci / test | agents-smoke | 1s | 46 |
...
## Slowest tests (latest instrumented run, `9b70a2380`)

| test | wall |
|---|---:|
| `phux-server::perf_bursty_output::synthesize_against_reference_alloc_bounded_under_full_churn` | 112.358s |
| `phux-server::terminal_actor::tests::resize_desync_then_both_shrink_does_not_overflow` | 28.225s |
...
| `phux::bin/phux::commands::overlay::tests::wedged_tailscale_binary_is_killed_at_the_deadline` | 2.024s |
