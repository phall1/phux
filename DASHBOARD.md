...
Generated 2026-07-15T11:27:18Z by the ci-metrics workflow. Do not edit —
...
|---|---:|---:|---:|---:|
| test | 88 | 2s | 13m22s | 16m55s |
| check | 87 | 2s | 2m37s | 4m23s |
| detect docs-only | 89 | 2s | 5s | 7s |

## Slowest ci steps (median, last 30 days)

| job | step | median | samples |
|---|---|---:|---:|
| test | tests (unit + e2e) | 13m18s | 14 |
| check | rust checks (fmt + clippy + doc + deny) | 3m05s | 19 |
...
|---|---|---:|---:|
| ci / check | clippy | 1m59s | 41 |
| ci / check | doc | 14s | 41 |
| ci / check | deny | 3s | 41 |
| ci / check | fmt | 1s | 43 |
| ci / test | unit | 12m02s | 34 |
| ci / test | e2e | 9s | 33 |
...
## Slowest tests (latest instrumented run, `b08125350`)

| test | wall |
|---|---:|
| `phux-server::perf_bursty_output::synthesize_against_reference_alloc_bounded_under_full_churn` | 112.874s |
| `phux-server::terminal_actor::tests::resize_desync_then_both_shrink_does_not_overflow` | 27.313s |
