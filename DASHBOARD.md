...
Generated 2026-08-02T05:21:31Z by the ci-metrics workflow. Do not edit —
...
|---|---:|---:|---:|---:|
| test | 306 | 2s | 13m22s | 17m46s |
| check | 304 | 2s | 3m15s | 5m11s |
| detect docs-only | 308 | 2s | 5s | 8s |

## Slowest ci steps (median, last 30 days)

| job | step | median | samples |
|---|---|---:|---:|
| test | tests (unit + e2e) | 14m07s | 13 |
| check | rust checks (fmt + clippy + doc + deny) | 1m37s | 14 |
| check | Run Swatinem/rust-cache@v2 | 21s | 15 |
| check | runner disk headroom | 19s | 16 |
| test | Run Swatinem/rust-cache@v2 | 19s | 15 |
| test | runner disk headroom | 15s | 16 |
...
|---|---|---:|---:|
| ci / check | clippy | 1m51s | 169 |
| ci / check | doc | 10s | 169 |
| ci / check | deny | 4s | 168 |
| ci / check | fmt | 2s | 173 |
| ci / test | unit | 12m50s | 155 |
| ci / test | e2e | 10s | 152 |
| ci / test | agents-smoke | 1s | 93 |
...
## Slowest tests (latest instrumented run, `0bd8f5375`)

| test | wall |
|---|---:|
| `phux-server::terminal_actor::tests::resize_desync_then_both_shrink_does_not_overflow` | 14.224s |
| `phux-server::agent_detect::a_plain_shell_pane_never_gets_an_agent_record` | 6.013s |
...
| `phux-record::golden_cast::both_containers_agree_on_the_frame_count_for_one_recording` | 2.213s |
...
| 2026-08-02 04:36 | ci | push | main | success | 20m31s | 17m55s |
