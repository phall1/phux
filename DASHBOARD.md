...
Generated 2026-08-02T05:43:50Z by the ci-metrics workflow. Do not edit —
...
|---|---:|---:|---:|---:|
| test | 310 | 2s | 13m21s | 17m46s |
| check | 308 | 2s | 3m15s | 5m11s |
| detect docs-only | 312 | 2s | 5s | 8s |

## Slowest ci steps (median, last 30 days)

| job | step | median | samples |
|---|---|---:|---:|
| test | tests (unit + e2e) | 12m28s | 14 |
...
|---|---|---:|---:|
| ci / check | clippy | 1m51s | 173 |
| ci / check | doc | 10s | 173 |
| ci / check | deny | 3s | 172 |
| ci / check | fmt | 2s | 177 |
| ci / test | unit | 12m46s | 159 |
| ci / test | e2e | 11s | 156 |
| ci / test | agents-smoke | 1s | 96 |
...
## Slowest tests (latest instrumented run, `6137613bd`)

| test | wall |
|---|---:|
| `phux-server::terminal_actor::tests::resize_desync_then_both_shrink_does_not_overflow` | 14.310s |
