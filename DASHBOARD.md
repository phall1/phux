...
Generated 2026-08-02T04:15:08Z by the ci-metrics workflow. Do not edit —
...
## Slowest tests (latest instrumented run, `4bbe113e4`)

| test | wall |
|---|---:|
| `phux-server::perf_bursty_output::synthesize_against_reference_alloc_bounded_under_full_churn` | 109.634s |
| `phux-server::terminal_actor::tests::resize_desync_then_both_shrink_does_not_overflow` | 27.944s |
...
| `phux-record::golden_cast::both_containers_agree_on_the_frame_count_for_one_recording` | 3.745s |
