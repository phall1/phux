...
Generated 2026-07-15T11:28:00Z by the ci-metrics workflow. Do not edit —
...
|---|---:|---:|---:|---:|
| test | 89 | 2s | 13m25s | 16m55s |
| check | 88 | 2s | 2m37s | 4m24s |
| detect docs-only | 90 | 2s | 5s | 7s |

## Slowest ci steps (median, last 30 days)

| job | step | median | samples |
|---|---|---:|---:|
| test | tests (unit + e2e) | 14m54s | 15 |
| check | rust checks (fmt + clippy + doc + deny) | 3m10s | 19 |
