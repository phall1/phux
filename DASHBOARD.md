...
Generated 2026-08-02T18:02:42Z by the ci-metrics workflow. Do not edit —
...
|---|---:|---:|---:|---:|
| test | 357 | 2s | 12m08s | 17m38s |
| check | 355 | 2s | 2m38s | 5m05s |
| detect docs-only | 358 | 2s | 5s | 8s |
...
|---|---|---:|---:|
| ci / check | clippy | 1m40s | 198 |
| ci / check | doc | 10s | 198 |
| ci / check | deny | 3s | 197 |
| ci / check | fmt | 2s | 203 |
| ci / test | unit | 12m31s | 184 |
| ci / test | e2e | 11s | 181 |
| ci / test | agents-smoke | 1s | 121 |
...
## Slowest tests (latest instrumented run, `e070861c5`)

| test | wall |
|---|---:|
| `phux-server::terminal_actor::tests::resize_desync_then_both_shrink_does_not_overflow` | 2.672s |
