...
Generated 2026-08-02T06:18:48Z by the ci-metrics workflow. Do not edit —
...
|---|---:|---:|---:|---:|
| test | 325 | 2s | 13m04s | 17m40s |
| check | 323 | 2s | 2m52s | 5m05s |
| detect docs-only | 327 | 2s | 5s | 8s |

## Slowest ci steps (median, last 30 days)

| job | step | median | samples |
|---|---|---:|---:|
| test | tests (unit + e2e) | 9m57s | 12 |
| check | rust checks (fmt + clippy + doc + deny) | 1m20s | 13 |
...
|---|---|---:|---:|
| ci / check | clippy | 1m48s | 179 |
| ci / check | doc | 10s | 179 |
| ci / check | deny | 3s | 178 |
| ci / check | fmt | 2s | 184 |
| ci / test | unit | 12m40s | 165 |
| ci / test | e2e | 11s | 162 |
| ci / test | agents-smoke | 1s | 102 |
...
## Slowest tests (latest instrumented run, `d1df7f528`)

| test | wall |
|---|---:|
| `phux-server::terminal_actor::tests::resize_desync_then_both_shrink_does_not_overflow` | 14.303s |
...
| `phux-record::golden_cast::both_containers_agree_on_the_frame_count_for_one_recording` | 2.205s |
