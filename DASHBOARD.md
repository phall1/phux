...
Generated 2026-08-02T06:17:13Z by the ci-metrics workflow. Do not edit —
...
|---|---:|---:|---:|---:|
| test | 324 | 2s | 13m04s | 17m40s |
| check | 322 | 2s | 2m52s | 5m05s |
| detect docs-only | 326 | 2s | 5s | 8s |
...
|---|---|---:|---:|
| ci / check | clippy | 1m48s | 178 |
| ci / check | doc | 10s | 178 |
| ci / check | deny | 3s | 177 |
| ci / check | fmt | 2s | 183 |
| ci / test | unit | 12m40s | 164 |
| ci / test | e2e | 11s | 161 |
| ci / test | agents-smoke | 1s | 101 |
...
## Slowest tests (latest instrumented run, `af06b9421`)

| test | wall |
|---|---:|
| `phux-server::terminal_actor::tests::resize_desync_then_both_shrink_does_not_overflow` | 14.321s |
...
| `phux-record::golden_cast::both_containers_agree_on_the_frame_count_for_one_recording` | 2.224s |
