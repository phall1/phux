...
|---|---:|---:|---:|---:|
| test | 303 | 2s | 13m25s | 17m46s |
| check | 301 | 2s | 3m15s | 5m12s |
| detect docs-only | 305 | 2s | 5s | 8s |

## Slowest ci steps (median, last 30 days)

| job | step | median | samples |
|---|---|---:|---:|
| test | tests (unit + e2e) | 14m40s | 12 |
| check | rust checks (fmt + clippy + doc + deny) | 1m39s | 13 |
| check | runner disk headroom | 31s | 15 |
| test | runner disk headroom | 25s | 15 |
...
|---|---|---:|---:|
| ci / check | clippy | 1m51s | 166 |
| ci / check | doc | 10s | 166 |
| ci / check | deny | 4s | 165 |
| ci / check | fmt | 2s | 170 |
...
## Slowest tests (latest instrumented run, `570781dce`)

| test | wall |
|---|---:|
| `phux-server::terminal_actor::tests::resize_desync_then_both_shrink_does_not_overflow` | 13.923s |
...
| `phux-record::golden_cast::both_containers_agree_on_the_frame_count_for_one_recording` | 2.583s |
