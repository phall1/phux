...
Generated 2026-07-15T09:02:09Z by the ci-metrics workflow. Do not edit —
...
|---|---:|---:|---:|---:|
| test | 39 | 2s | 13m25s | 17m22s |
| check | 39 | 2s | 2m37s | 4m12s |
| detect docs-only | 40 | 2s | 5s | 7s |

## Slowest ci steps (median, last 30 days)

| job | step | median | samples |
|---|---|---:|---:|
| test | tests (unit + e2e) | 12m42s | 18 |
...
|---|---|---:|---:|
| ci / check | clippy | 41s | 9 |
| ci / check | doc | 14s | 9 |
| ci / check | deny | 3s | 9 |
| ci / check | fmt | 1s | 9 |
| ci / test | unit | 11m56s | 7 |
| ci / test | e2e | 9s | 7 |
...
## Slowest tests (latest instrumented run, `0abd5a5ed`)

| test | wall |
|---|---:|
| `phux-server::perf_bursty_output::synthesize_against_reference_alloc_bounded_under_full_churn` | 112.189s |
| `phux-server::terminal_actor::tests::resize_desync_then_both_shrink_does_not_overflow` | 27.748s |
