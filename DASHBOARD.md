...
Generated 2026-07-25T21:30:58Z by the ci-metrics workflow. Do not edit —
...
|---|---:|---:|---:|---:|---:|
| ci | 179 | 60% | 13m31s | 18m08s | 2193 |
| stress | 20 | 65% | 18m05s | 23m45s | 257 |
| observatory | 9 | 78% | 12m07s | 12m42s | 190 |
| release-please | 31 | 97% | 43s | 7m03s | 72 |
| conventional-commits | 165 | 84% | 16s | 21s | 35 |

## ci jobs, last 30 days

| job | runs | median queue | median wall | p95 wall |
|---|---:|---:|---:|---:|
| test | 178 | 2s | 13m19s | 17m49s |
| check | 176 | 2s | 2m43s | 5m03s |
| detect docs-only | 179 | 2s | 5s | 7s |

## Slowest ci steps (median, last 30 days)

| job | step | median | samples |
|---|---|---:|---:|
| test | tests (unit + e2e) | 15m44s | 10 |
| check | rust checks (fmt + clippy + doc + deny) | 3m08s | 11 |
...
|---|---|---:|---:|
| ci / check | clippy | 2m00s | 93 |
| ci / check | doc | 12s | 93 |
| ci / check | deny | 4s | 93 |
| ci / check | fmt | 1s | 96 |
| ci / test | unit | 14m14s | 83 |
| ci / test | e2e | 10s | 82 |
| ci / test | agents-smoke | 1s | 23 |
...
## Slowest tests (latest instrumented run, `c6e5c1889`)

| test | wall |
|---|---:|
| `phux-server::perf_bursty_output::synthesize_against_reference_alloc_bounded_under_full_churn` | 110.820s |
| `phux-server::terminal_actor::tests::resize_desync_then_both_shrink_does_not_overflow` | 27.258s |
