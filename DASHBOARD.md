...
Generated 2026-08-03T05:07:18Z by the ci-metrics workflow. Do not edit —
...
|---|---:|---:|---:|---:|---:|
| ci | 429 | 54% | 11m16s | 18m14s | 4670 |
| observatory | 24 | 92% | 12m23s | 12m56s | 559 |
| stress | 42 | 36% | 11s | 22m15s | 334 |
| release-please | 92 | 97% | 47s | 7m37s | 206 |
| conventional-commits | 392 | 80% | 16s | 25s | 79 |
...
|---|---:|---:|---:|---:|
| test | 421 | 2s | 10m52s | 17m30s |
| check | 421 | 2s | 2m32s | 5m05s |
| detect docs-only | 424 | 2s | 5s | 8s |

## Slowest ci steps (median, last 30 days)

| job | step | median | samples |
|---|---|---:|---:|
| test | tests (unit + e2e) | 9m13s | 9 |
| check | rust checks (fmt + clippy + doc + deny) | 1m14s | 11 |
...
| check | Run DeterminateSystems/nix-installer-action@v22 | 6s | 12 |

## Cargo phases inside the lanes (median, last 30 days)

| workflow / job | phase | median | samples |
|---|---|---:|---:|
| ci / check | clippy | 1m38s | 233 |
| ci / check | doc | 10s | 233 |
| ci / check | deny | 3s | 231 |
| ci / check | fmt | 2s | 239 |
| ci / test | unit | 12m04s | 214 |
| ci / test | e2e | 12s | 210 |
| ci / test | agents-smoke | 1s | 150 |
...
## Slowest tests (latest instrumented run, `3029212d8`)

| test | wall |
|---|---:|
| `phux-server::terminal_actor::tests::resize_desync_then_both_shrink_does_not_overflow` | 3.984s |
| `phux-record::golden_cast::golden_cast_renders_gif_and_apng_and_frame_counts_agree` | 3.981s |
