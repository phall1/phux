...
Generated 2026-07-15T18:42:30Z by the ci-metrics workflow. Do not edit —
...
|---|---:|---:|---:|---:|
| test | 115 | 2s | 13m18s | 16m59s |
| check | 114 | 2s | 2m35s | 4m26s |
| detect docs-only | 116 | 2s | 5s | 7s |

## Slowest ci steps (median, last 30 days)

| job | step | median | samples |
|---|---|---:|---:|
| test | tests (unit + e2e) | 15m12s | 15 |
| check | rust checks (fmt + clippy + doc + deny) | 3m10s | 15 |
...
|---|---|---:|---:|
| ci / check | clippy | 2m02s | 57 |
| ci / check | doc | 14s | 57 |
| ci / check | deny | 3s | 57 |
| ci / check | fmt | 1s | 59 |
| ci / test | unit | 13m02s | 49 |
| ci / test | e2e | 9s | 48 |
...
## Slowest tests (latest instrumented run, `127a8d226`)

| test | wall |
|---|---:|
| `phux-server::perf_bursty_output::synthesize_against_reference_alloc_bounded_under_full_churn` | 111.029s |
| `phux-server::terminal_actor::tests::resize_desync_then_both_shrink_does_not_overflow` | 27.385s |
