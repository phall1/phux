...
Generated 2026-08-01T23:32:18Z by the ci-metrics workflow. Do not edit —
...
|---|---:|---:|---:|---:|---:|
| ci | 268 | 58% | 13m37s | 18m24s | 3279 |
| observatory | 16 | 88% | 12m07s | 12m56s | 360 |
| stress | 33 | 45% | 6m13s | 22m37s | 325 |
| release-please | 54 | 98% | 45s | 7m42s | 144 |
| conventional-commits | 239 | 82% | 16s | 22s | 50 |

## ci jobs, last 30 days

| job | runs | median queue | median wall | p95 wall |
|---|---:|---:|---:|---:|
| test | 265 | 2s | 13m26s | 17m49s |
| check | 263 | 2s | 3m16s | 5m12s |
| detect docs-only | 268 | 2s | 5s | 8s |
...
| check | rust checks (fmt + clippy + doc + deny) | 2m40s | 18 |
| check | runner disk headroom | 38s | 18 |
| test | runner disk headroom | 27s | 18 |
...
|---|---|---:|---:|
| ci / check | clippy | 1m53s | 146 |
| ci / check | doc | 11s | 146 |
| ci / check | deny | 4s | 145 |
| ci / check | fmt | 2s | 149 |
| ci / test | unit | 13m24s | 133 |
| ci / test | e2e | 10s | 130 |
| ci / test | agents-smoke | 1s | 71 |
...
## Slowest tests (latest instrumented run, `e6958c959`)

| test | wall |
|---|---:|
| `phux-server::perf_bursty_output::synthesize_against_reference_alloc_bounded_under_full_churn` | 110.317s |
| `phux-server::terminal_actor::tests::resize_desync_then_both_shrink_does_not_overflow` | 27.654s |
...
| `phux-record::golden_cast::both_containers_agree_on_the_frame_count_for_one_recording` | 3.189s |
