...
Generated 2026-07-15T20:22:37Z by the ci-metrics workflow. Do not edit —
...
|---|---:|---:|---:|---:|---:|
| ci | 140 | 60% | 13m29s | 17m15s | 1734 |
| observatory | 5 | 80% | 11m56s | 12m25s | 118 |
| stress | 6 | 50% | 6s | 21m33s | 65 |
| release-please | 21 | 100% | 42s | 54s | 28 |
| conventional-commits | 131 | 85% | 15s | 20s | 24 |

## ci jobs, last 30 days

| job | runs | median queue | median wall | p95 wall |
|---|---:|---:|---:|---:|
| test | 139 | 2s | 13m19s | 17m06s |
| check | 137 | 2s | 2m39s | 4m29s |
| detect docs-only | 140 | 2s | 5s | 7s |

## Slowest ci steps (median, last 30 days)

| job | step | median | samples |
|---|---|---:|---:|
| test | tests (unit + e2e) | 15m35s | 15 |
...
|---|---|---:|---:|
| ci / check | clippy | 2m01s | 73 |
| ci / check | doc | 14s | 73 |
| ci / check | deny | 4s | 73 |
| ci / check | fmt | 1s | 76 |
| ci / test | unit | 14m04s | 63 |
| ci / test | e2e | 9s | 62 |
| ci / test | agents-smoke | 1s | 3 |
...
## Slowest tests (latest instrumented run, `fc5b15def`)

| test | wall |
|---|---:|
| `phux-server::perf_bursty_output::synthesize_against_reference_alloc_bounded_under_full_churn` | 88.630s |
| `phux-server::terminal_actor::tests::resize_desync_then_both_shrink_does_not_overflow` | 23.029s |
