...
Generated 2026-07-15T10:58:28Z by the ci-metrics workflow. Do not edit —
...
|---|---:|---:|---:|---:|---:|
| ci | 83 | 63% | 13m36s | 16m52s | 1059 |
| stress | 6 | 50% | 6s | 21m33s | 65 |
| observatory | 2 | 100% | 11m44s | 11m44s | 47 |
| release-please | 13 | 100% | 37s | 48s | 23 |
| conventional-commits | 72 | 92% | 16s | 19s | 14 |

## ci jobs, last 30 days

| job | runs | median queue | median wall | p95 wall |
|---|---:|---:|---:|---:|
| test | 82 | 2s | 13m22s | 16m41s |
| check | 81 | 2s | 2m37s | 4m23s |
| detect docs-only | 83 | 2s | 5s | 7s |
...
|---|---|---:|---:|
| ci / check | clippy | 1m52s | 38 |
| ci / check | doc | 14s | 38 |
| ci / check | deny | 3s | 38 |
| ci / check | fmt | 1s | 40 |
| ci / test | unit | 11m57s | 31 |
| ci / test | e2e | 8s | 30 |
...
## Slowest tests (latest instrumented run, `0579e88f1`)

| test | wall |
|---|---:|
| `phux-server::perf_bursty_output::synthesize_against_reference_alloc_bounded_under_full_churn` | 111.392s |
| `phux-server::terminal_actor::tests::resize_desync_then_both_shrink_does_not_overflow` | 27.224s |
