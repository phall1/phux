...
Generated 2026-08-02T07:30:59Z by the ci-metrics workflow. Do not edit —
...
|---|---:|---:|---:|---:|---:|
| ci | 346 | 56% | 13m05s | 18m24s | 4011 |
| observatory | 18 | 89% | 12m23s | 13m00s | 410 |
| stress | 35 | 43% | 5m20s | 22m37s | 325 |
| release-please | 74 | 99% | 45s | 7m37s | 173 |
| conventional-commits | 311 | 80% | 16s | 24s | 64 |

## ci jobs, last 30 days

| job | runs | median queue | median wall | p95 wall |
|---|---:|---:|---:|---:|
| test | 340 | 2s | 12m44s | 17m40s |
| check | 338 | 2s | 2m40s | 5m05s |
| detect docs-only | 341 | 2s | 5s | 8s |

## Slowest ci steps (median, last 30 days)

| job | step | median | samples |
|---|---|---:|---:|
| test | tests (unit + e2e) | 9m57s | 13 |
| check | rust checks (fmt + clippy + doc + deny) | 1m21s | 13 |
| check | Run Swatinem/rust-cache@v2 | 17s | 14 |
| test | Run Swatinem/rust-cache@v2 | 17s | 14 |
...
|---|---|---:|---:|
| ci / check | clippy | 1m42s | 188 |
| ci / check | doc | 10s | 188 |
| ci / check | deny | 3s | 187 |
| ci / check | fmt | 2s | 193 |
| ci / test | unit | 12m35s | 174 |
| ci / test | e2e | 11s | 171 |
| ci / test | agents-smoke | 1s | 111 |
...
## Slowest tests (latest instrumented run, `b5b037af2`)

| test | wall |
|---|---:|
| `phux-server::terminal_actor::tests::resize_desync_then_both_shrink_does_not_overflow` | 14.407s |
...
| `phux-record::golden_cast::both_containers_agree_on_the_frame_count_for_one_recording` | 2.346s |
