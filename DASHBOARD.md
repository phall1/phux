...
Generated 2026-07-15T11:16:55Z by the ci-metrics workflow. Do not edit —
...
|---|---:|---:|---:|---:|
| test | 87 | 2s | 13m22s | 16m41s |
| check | 86 | 2s | 2m36s | 4m23s |
| detect docs-only | 88 | 2s | 5s | 7s |

## Slowest ci steps (median, last 30 days)

| job | step | median | samples |
|---|---|---:|---:|
| test | tests (unit + e2e) | 13m14s | 14 |
| check | rust checks (fmt + clippy + doc + deny) | 2m49s | 18 |
...
|---|---|---:|---:|
| ci / check | clippy | 1m53s | 40 |
| ci / check | doc | 14s | 40 |
| ci / check | deny | 3s | 40 |
| ci / check | fmt | 1s | 42 |
| ci / test | unit | 12m02s | 33 |
| ci / test | e2e | 9s | 32 |
...
## Slowest tests (latest instrumented run, `44ade3883`)

| test | wall |
|---|---:|
| `phux-server::perf_bursty_output::synthesize_against_reference_alloc_bounded_under_full_churn` | 108.022s |
| `phux-server::terminal_actor::tests::resize_desync_then_both_shrink_does_not_overflow` | 28.275s |
