...
Generated 2026-08-02T05:35:04Z by the ci-metrics workflow. Do not edit —
...
|---|---:|---:|---:|---:|
| test | 308 | 2s | 13m22s | 17m46s |
| check | 306 | 2s | 3m15s | 5m11s |
| detect docs-only | 310 | 2s | 5s | 8s |

## Slowest ci steps (median, last 30 days)

| job | step | median | samples |
|---|---|---:|---:|
| test | tests (unit + e2e) | 13m22s | 15 |
...
| test | runner disk headroom | 10s | 18 |
| check | Run DeterminateSystems/nix-installer-action@v22 | 8s | 18 |
| check | runner disk headroom | 8s | 18 |
...
|---|---|---:|---:|
| ci / check | clippy | 1m51s | 171 |
| ci / check | doc | 10s | 171 |
| ci / check | deny | 4s | 170 |
| ci / check | fmt | 2s | 175 |
| ci / test | unit | 12m46s | 157 |
| ci / test | e2e | 11s | 154 |
| ci / test | agents-smoke | 1s | 95 |
...
## Slowest tests (latest instrumented run, `68abb9360`)
