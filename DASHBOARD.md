...
Generated 2026-08-02T23:48:36Z by the ci-metrics workflow. Do not edit —
...
|---|---:|---:|---:|---:|
| test | 374 | 2s | 11m30s | 17m34s |
| check | 372 | 2s | 2m37s | 5m05s |
| detect docs-only | 375 | 2s | 5s | 8s |
...
| check | rust checks (fmt + clippy + doc + deny) | 2m52s | 15 |
...
|---|---|---:|---:|
| ci / check | clippy | 1m42s | 207 |
| ci / check | doc | 10s | 207 |
| ci / check | deny | 3s | 206 |
| ci / check | fmt | 2s | 213 |
| ci / test | unit | 12m22s | 192 |
| ci / test | e2e | 11s | 188 |
| ci / test | agents-smoke | 1s | 128 |
...
## Slowest tests (latest instrumented run, `441192ba8`)

| test | wall |
|---|---:|
| `phux-record::golden_cast::golden_cast_renders_gif_and_apng_and_frame_counts_agree` | 3.990s |
| `phux-server::terminal_actor::tests::resize_desync_then_both_shrink_does_not_overflow` | 3.962s |
