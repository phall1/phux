...
Generated 2026-07-15T18:24:49Z by the ci-metrics workflow. Do not edit —
...
|---|---:|---:|---:|---:|---:|
| ci | 107 | 59% | 13m17s | 17m05s | 1286 |
| observatory | 4 | 75% | 11m54s | 11m56s | 94 |
| stress | 6 | 50% | 6s | 21m33s | 65 |
| release-please | 17 | 100% | 40s | 52s | 25 |
| conventional-commits | 102 | 86% | 16s | 20s | 19 |

## ci jobs, last 30 days

| job | runs | median queue | median wall | p95 wall |
|---|---:|---:|---:|---:|
| test | 106 | 2s | 13m04s | 16m52s |
| check | 105 | 2s | 2m36s | 4m26s |
| detect docs-only | 107 | 2s | 5s | 7s |
...
| check | rust checks (fmt + clippy + doc + deny) | 3m26s | 13 |
...
|---|---|---:|---:|
| ci / check | clippy | 2m08s | 50 |
| ci / check | doc | 14s | 50 |
| ci / check | deny | 3s | 50 |
| ci / check | fmt | 1s | 52 |
| ci / test | unit | 12m04s | 42 |
| ci / test | e2e | 9s | 41 |
...
## Slowest tests (latest instrumented run, `4267ab0a2`)

| test | wall |
|---|---:|
| `phux-server::perf_bursty_output::synthesize_against_reference_alloc_bounded_under_full_churn` | 110.714s |
| `phux-server::terminal_actor::tests::resize_desync_then_both_shrink_does_not_overflow` | 27.267s |
