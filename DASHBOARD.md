...
Generated 2026-07-26T02:16:21Z by the ci-metrics workflow. Do not edit —
...
| check | 214 | 2s | 2m47s | 5m05s |
| detect docs-only | 219 | 2s | 5s | 7s |
...
| check | rust checks (fmt + clippy + doc + deny) | 1m40s | 13 |
