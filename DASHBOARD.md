...
Generated 2026-08-03T02:31:41Z by the ci-metrics workflow. Do not edit —
...
|---|---:|---:|---:|---:|
| test | 392 | 2s | 11m17s | 17m30s |
| check | 391 | 2s | 2m35s | 5m05s |
| detect docs-only | 394 | 2s | 5s | 8s |
...
|---|---|---:|---:|
| ci / check | clippy | 1m39s | 218 |
| ci / check | doc | 10s | 218 |
| ci / check | deny | 3s | 217 |
| ci / check | fmt | 2s | 224 |
| ci / test | unit | 12m11s | 202 |
| ci / test | e2e | 11s | 198 |
| ci / test | agents-smoke | 1s | 138 |
...
## Slowest tests (latest instrumented run, `decde8631`)

| test | wall |
|---|---:|
| `phux-record::golden_cast::golden_cast_renders_gif_and_apng_and_frame_counts_agree` | 4.290s |
| `phux-server::terminal_actor::tests::resize_desync_then_both_shrink_does_not_overflow` | 3.961s |
