...
Generated 2026-07-15T10:33:05Z by the ci-metrics workflow. Do not edit —
...
|---|---:|---:|---:|---:|---:|
| ci | 76 | 59% | 13m13s | 16m51s | 929 |
| stress | 6 | 50% | 6s | 21m33s | 65 |
| observatory | 2 | 100% | 11m44s | 11m44s | 47 |
| release-please | 13 | 100% | 37s | 48s | 23 |
| conventional-commits | 70 | 91% | 16s | 19s | 13 |

## ci jobs, last 30 days

| job | runs | median queue | median wall | p95 wall |
|---|---:|---:|---:|---:|
| test | 75 | 2s | 13m04s | 16m41s |
| check | 74 | 2s | 2m36s | 4m23s |
| detect docs-only | 76 | 2s | 5s | 7s |

## Slowest ci steps (median, last 30 days)

| job | step | median | samples |
|---|---|---:|---:|
| test | tests (unit + e2e) | 12m44s | 9 |
| check | rust checks (fmt + clippy + doc + deny) | 2m49s | 15 |
| test | Run Swatinem/rust-cache@v2 | 23s | 18 |
| check | Run Swatinem/rust-cache@v2 | 22s | 19 |
...
|---|---|---:|---:|
| ci / check | clippy | 1m59s | 31 |
| ci / check | doc | 14s | 31 |
| ci / check | deny | 3s | 31 |
| ci / check | fmt | 1s | 33 |
| ci / test | unit | 11m51s | 24 |
| ci / test | e2e | 8s | 23 |
...
## Slowest tests (latest instrumented run, `328d34786`)

| test | wall |
|---|---:|
| `phux-server::perf_bursty_output::synthesize_against_reference_alloc_bounded_under_full_churn` | 111.041s |
| `phux-server::terminal_actor::tests::resize_desync_then_both_shrink_does_not_overflow` | 28.486s |
