...
Generated 2026-07-27T20:34:51Z by the ci-metrics workflow. Do not edit —
...
|---|---:|---:|---:|---:|---:|
| ci | 255 | 59% | 13m37s | 18m14s | 3071 |
| observatory | 15 | 87% | 12m07s | 12m56s | 336 |
| stress | 26 | 50% | 6m13s | 22m37s | 270 |
| release-please | 51 | 98% | 45s | 7m36s | 122 |
...
|---|---:|---:|---:|---:|
| test | 252 | 2s | 13m26s | 17m46s |
| check | 250 | 2s | 3m15s | 5m12s |
| detect docs-only | 255 | 2s | 5s | 8s |
...
| check | runner disk headroom | 38s | 17 |
...
| check | formula-check | 6s | 13 |
| check | e2e lane coverage | 5s | 13 |

## Cargo phases inside the lanes (median, last 30 days)

| workflow / job | phase | median | samples |
|---|---|---:|---:|
| ci / check | clippy | 1m55s | 137 |
| ci / check | doc | 11s | 137 |
| ci / check | deny | 3s | 136 |
| ci / check | fmt | 2s | 140 |
| ci / test | unit | 13m24s | 125 |
| ci / test | e2e | 10s | 124 |
| ci / test | agents-smoke | 1s | 65 |
...
## Slowest tests (latest instrumented run, `f23f21794`)

| test | wall |
|---|---:|
| `phux-server::perf_bursty_output::synthesize_against_reference_alloc_bounded_under_full_churn` | 70.518s |
| `phux-server::terminal_actor::tests::resize_desync_then_both_shrink_does_not_overflow` | 18.081s |
