...
Generated 2026-08-01T23:31:07Z by the ci-metrics workflow. Do not edit —
...
|---|---:|---:|---:|---:|
| test | 263 | 2s | 13m27s | 17m49s |
| check | 261 | 2s | 3m17s | 5m14s |
| detect docs-only | 266 | 2s | 5s | 8s |

## Slowest ci steps (median, last 30 days)

| job | step | median | samples |
|---|---|---:|---:|
| test | tests (unit + e2e) | 14m19s | 16 |
| check | rust checks (fmt + clippy + doc + deny) | 2m40s | 19 |
| check | runner disk headroom | 38s | 19 |
| test | runner disk headroom | 27s | 20 |
| check | Run Swatinem/rust-cache@v2 | 19s | 19 |
| test | Run Swatinem/rust-cache@v2 | 17s | 20 |
