...
Generated 2026-07-27T12:05:18Z by the ci-metrics workflow. Do not edit —
...
|---|---:|---:|---:|---:|---:|
| ci | 242 | 58% | 13m34s | 18m08s | 2879 |
| observatory | 14 | 86% | 12m07s | 12m56s | 315 |
| stress | 24 | 54% | 6m52s | 22m37s | 270 |
| release-please | 47 | 98% | 45s | 7m03s | 100 |
| conventional-commits | 220 | 82% | 16s | 21s | 45 |

## ci jobs, last 30 days

| job | runs | median queue | median wall | p95 wall |
|---|---:|---:|---:|---:|
| test | 239 | 2s | 13m25s | 17m49s |
| check | 237 | 2s | 2m57s | 5m11s |
| detect docs-only | 242 | 2s | 5s | 8s |
...
| check | formula-check | 6s | 3 |
| check | e2e lane coverage | 5s | 3 |

## Cargo phases inside the lanes (median, last 30 days)

| workflow / job | phase | median | samples |
|---|---|---:|---:|
| ci / check | clippy | 1m59s | 127 |
| ci / check | doc | 11s | 127 |
| ci / check | deny | 4s | 126 |
| ci / check | fmt | 2s | 130 |
| ci / test | unit | 13m41s | 116 |
| ci / test | e2e | 10s | 115 |
| ci / test | agents-smoke | 1s | 56 |
...
## Slowest tests (latest instrumented run, `c0ced3eb8`)

| test | wall |
|---|---:|
| `phux-server::perf_bursty_output::synthesize_against_reference_alloc_bounded_under_full_churn` | 83.509s |
| `phux-server::terminal_actor::tests::resize_desync_then_both_shrink_does_not_overflow` | 20.610s |
| `phux-server::agent_detect::a_plain_shell_pane_never_gets_an_agent_record` | 6.015s |
| `phux-relay::relay_auth::stalled_preamble_does_not_wedge_relay` | 5.177s |
...
| `phux-record::golden_cast::both_containers_agree_on_the_frame_count_for_one_recording` | 2.338s |
