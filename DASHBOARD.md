...
Generated 2026-07-27T13:43:32Z by the ci-metrics workflow. Do not edit —
...
|---|---:|---:|---:|---:|
| test | 244 | 2s | 13m25s | 17m46s |
| check | 242 | 2s | 3m01s | 5m05s |
| detect docs-only | 247 | 2s | 5s | 8s |
...
| check | runner disk headroom | 38s | 16 |
...
| check | e2e lane coverage | 5s | 7 |
| check | formula-check | 5s | 7 |

## Cargo phases inside the lanes (median, last 30 days)

| workflow / job | phase | median | samples |
|---|---|---:|---:|
| ci / check | clippy | 1m57s | 131 |
| ci / check | doc | 11s | 131 |
| ci / check | deny | 4s | 130 |
| ci / check | fmt | 2s | 134 |
| ci / test | unit | 13m41s | 119 |
| ci / test | e2e | 10s | 118 |
| ci / test | agents-smoke | 1s | 59 |
...
## Slowest tests (latest instrumented run, `0830cfa99`)

| test | wall |
|---|---:|
| `phux-server::perf_bursty_output::synthesize_against_reference_alloc_bounded_under_full_churn` | 108.895s |
| `phux-server::terminal_actor::tests::resize_desync_then_both_shrink_does_not_overflow` | 27.231s |
...
| `phux-record::golden_cast::both_containers_agree_on_the_frame_count_for_one_recording` | 3.805s |
...
| `phux-record::golden_cast::golden_cast_renders_to_a_looping_gif` | 2.532s |
