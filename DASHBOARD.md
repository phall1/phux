...
Generated 2026-07-26T01:26:24Z by the ci-metrics workflow. Do not edit —
...
|---|---:|---:|---:|---:|---:|
| ci | 210 | 59% | 13m31s | 18m14s | 2526 |
| stress | 20 | 65% | 18m05s | 23m45s | 257 |
| observatory | 10 | 80% | 12m07s | 12m56s | 215 |
| release-please | 38 | 97% | 44s | 7m03s | 76 |
| conventional-commits | 193 | 83% | 16s | 21s | 41 |

## ci jobs, last 30 days

| job | runs | median queue | median wall | p95 wall |
|---|---:|---:|---:|---:|
| test | 208 | 2s | 13m21s | 17m51s |
| check | 205 | 2s | 2m49s | 5m05s |
| detect docs-only | 210 | 2s | 5s | 7s |

## Slowest ci steps (median, last 30 days)

| job | step | median | samples |
|---|---|---:|---:|
| test | tests (unit + e2e) | 13m03s | 14 |
| check | rust checks (fmt + clippy + doc + deny) | 2m42s | 13 |
...
|---|---|---:|---:|
| ci / check | clippy | 1m59s | 109 |
| ci / check | doc | 11s | 109 |
| ci / check | deny | 4s | 109 |
| ci / check | fmt | 1s | 112 |
| ci / test | unit | 14m03s | 99 |
| ci / test | e2e | 10s | 98 |
| ci / test | agents-smoke | 1s | 39 |
...
## Slowest tests (latest instrumented run, `3a02845c5`)

| test | wall |
|---|---:|
| `phux-server::perf_bursty_output::synthesize_against_reference_alloc_bounded_under_full_churn` | 111.924s |
| `phux-server::terminal_actor::tests::resize_desync_then_both_shrink_does_not_overflow` | 28.124s |
