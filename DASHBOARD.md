...
Generated 2026-07-15T09:56:22Z by the ci-metrics workflow. Do not edit —
...
|---|---:|---:|---:|---:|
| test | 56 | 2s | 13m08s | 16m41s |
| check | 55 | 2s | 2m37s | 4m23s |
| detect docs-only | 57 | 2s | 5s | 7s |

## Slowest ci steps (median, last 30 days)

| job | step | median | samples |
|---|---|---:|---:|
| test | tests (unit + e2e) | 12m55s | 14 |
| check | rust checks (fmt + clippy + doc + deny) | 3m16s | 16 |
| check | Run Swatinem/rust-cache@v2 | 20s | 20 |
| test | Run Swatinem/rust-cache@v2 | 20s | 19 |
...
|---|---|---:|---:|
| ci / check | clippy | 2m08s | 18 |
| ci / check | doc | 14s | 18 |
| ci / check | deny | 3s | 18 |
| ci / check | fmt | 1s | 20 |
| ci / test | unit | 11m56s | 16 |
| ci / test | e2e | 8s | 15 |
...
## Slowest tests (latest instrumented run, `0a0cec840`)

| test | wall |
|---|---:|
| `phux-server::perf_bursty_output::synthesize_against_reference_alloc_bounded_under_full_churn` | 82.131s |
| `phux-server::terminal_actor::tests::resize_desync_then_both_shrink_does_not_overflow` | 20.463s |
...
| `phux-server::agent_detect::deleting_the_record_hands_it_back_to_the_detector` | 3.810s |
...
| `phux-server::phux_0q8_no_double_emit::live_output_is_delivered_exactly_once` | 1.513s |
...
| 2026-07-15 09:41 | ci | push | main | success | 13m37s | 17m48s |
