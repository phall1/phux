...
Generated 2026-08-02T17:42:25Z by the ci-metrics workflow. Do not edit —
...
|---|---:|---:|---:|---:|
| test | 356 | 2s | 12m07s | 17m38s |
| check | 354 | 2s | 2m37s | 5m05s |
| detect docs-only | 357 | 2s | 5s | 8s |
...
| check | rust checks (fmt + clippy + doc + deny) | 1m24s | 15 |
...
|---|---|---:|---:|
| ci / check | clippy | 1m40s | 197 |
| ci / check | doc | 10s | 197 |
| ci / check | deny | 3s | 196 |
| ci / check | fmt | 2s | 202 |
| ci / test | unit | 12m31s | 183 |
| ci / test | e2e | 11s | 180 |
| ci / test | agents-smoke | 1s | 120 |
...
## Slowest tests (latest instrumented run, `b26a0d0b6`)

| test | wall |
|---|---:|
| `phux-server::terminal_actor::tests::resize_desync_then_both_shrink_does_not_overflow` | 2.638s |
| `phux-record::golden_cast::golden_cast_renders_gif_and_apng_and_frame_counts_agree` | 2.199s |
