...
Generated 2026-08-03T01:31:22Z by the ci-metrics workflow. Do not edit —
...
|---|---:|---:|---:|---:|---:|
| ci | 393 | 55% | 11m43s | 18m24s | 4398 |
| observatory | 23 | 91% | 12m23s | 12m56s | 533 |
| stress | 40 | 38% | 2m39s | 22m37s | 334 |
| release-please | 85 | 98% | 46s | 7m37s | 200 |
| conventional-commits | 357 | 79% | 16s | 24s | 72 |

## ci jobs, last 30 days

| job | runs | median queue | median wall | p95 wall |
|---|---:|---:|---:|---:|
| test | 386 | 2s | 11m26s | 17m30s |
| check | 385 | 2s | 2m36s | 5m05s |
| detect docs-only | 388 | 2s | 5s | 8s |

## Slowest ci steps (median, last 30 days)

| job | step | median | samples |
|---|---|---:|---:|
| test | tests (unit + e2e) | 11m31s | 11 |
| check | rust checks (fmt + clippy + doc + deny) | 3m40s | 13 |
| check | Run Swatinem/rust-cache@v2 | 15s | 14 |
| test | Run Swatinem/rust-cache@v2 | 14s | 14 |
...
|---|---|---:|---:|
| ci / check | clippy | 1m42s | 214 |
| ci / check | doc | 10s | 214 |
| ci / check | deny | 3s | 213 |
| ci / check | fmt | 2s | 220 |
| ci / test | unit | 12m15s | 199 |
| ci / test | e2e | 11s | 195 |
| ci / test | agents-smoke | 1s | 135 |
...
## Slowest tests (latest instrumented run, `143bd6885`)

| test | wall |
|---|---:|
| `phux-record::golden_cast::golden_cast_renders_gif_and_apng_and_frame_counts_agree` | 3.984s |
| `phux-server::terminal_actor::tests::resize_desync_then_both_shrink_does_not_overflow` | 3.960s |
