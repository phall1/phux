...
Generated 2026-08-03T03:13:34Z by the ci-metrics workflow. Do not edit —
...
|---|---:|---:|---:|---:|---:|
| ci | 405 | 55% | 11m35s | 18m14s | 4496 |
| observatory | 24 | 92% | 12m23s | 12m56s | 559 |
| stress | 42 | 36% | 11s | 22m15s | 334 |
| release-please | 88 | 97% | 46s | 7m37s | 204 |
| conventional-commits | 367 | 79% | 16s | 24s | 74 |
...
|---|---:|---:|---:|---:|
| test | 398 | 2s | 11m17s | 17m30s |
| check | 397 | 2s | 2m35s | 5m05s |
| detect docs-only | 400 | 2s | 5s | 8s |
...
| check | rust checks (fmt + clippy + doc + deny) | 1m23s | 14 |
...
|---|---|---:|---:|
| ci / check | clippy | 1m40s | 221 |
| ci / check | doc | 10s | 221 |
| ci / check | deny | 3s | 220 |
| ci / check | fmt | 2s | 227 |
| ci / test | unit | 12m11s | 205 |
| ci / test | e2e | 11s | 201 |
| ci / test | agents-smoke | 1s | 141 |
...
## Slowest tests (latest instrumented run, `dc507ad34`)

| test | wall |
|---|---:|
| `phux-record::golden_cast::golden_cast_renders_gif_and_apng_and_frame_counts_agree` | 4.030s |
