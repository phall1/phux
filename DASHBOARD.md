...
Generated 2026-07-26T01:40:12Z by the ci-metrics workflow. Do not edit —
...
|---|---:|---:|---:|---:|
| test | 211 | 2s | 13m21s | 17m51s |
| check | 208 | 2s | 2m47s | 5m05s |
| detect docs-only | 213 | 2s | 5s | 7s |

## Slowest ci steps (median, last 30 days)

| job | step | median | samples |
|---|---|---:|---:|
| test | tests (unit + e2e) | 12m47s | 13 |
| check | rust checks (fmt + clippy + doc + deny) | 2m41s | 14 |
...
|---|---|---:|---:|
| ci / check | clippy | 1m57s | 110 |
| ci / check | doc | 11s | 110 |
| ci / check | deny | 4s | 110 |
| ci / check | fmt | 1s | 113 |
| ci / test | unit | 14m01s | 100 |
| ci / test | e2e | 10s | 99 |
| ci / test | agents-smoke | 1s | 40 |
...
## Slowest tests (latest instrumented run, `ef6216897`)

| test | wall |
|---|---:|
| `phux-server::perf_bursty_output::synthesize_against_reference_alloc_bounded_under_full_churn` | 112.284s |
| `phux-server::terminal_actor::tests::resize_desync_then_both_shrink_does_not_overflow` | 28.158s |
