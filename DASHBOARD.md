...
Generated 2026-08-03T06:11:24Z by the ci-metrics workflow. Do not edit —
...
|---|---:|---:|---:|---:|
| test | 431 | 2s | 10m43s | 17m30s |
| check | 432 | 2s | 2m33s | 5m12s |
| detect docs-only | 435 | 2s | 5s | 8s |
...
| check | rust checks (fmt + clippy + doc + deny) | 3m47s | 14 |
...
|---|---|---:|---:|
| ci / check | clippy | 1m40s | 241 |
| ci / check | doc | 10s | 241 |
| ci / check | deny | 3s | 239 |
| ci / check | fmt | 2s | 248 |
| ci / test | unit | 11m57s | 220 |
| ci / test | e2e | 12s | 214 |
...
## Slowest tests (latest instrumented run, `60b892f88`)

| test | wall |
|---|---:|
| `phux-server::spawn_terminal::spawn_terminal_emits_terminal_closed_on_pty_exit` | 15.080s |
| `phux-server::runtime::attach::tests::prepare_attach_rejects_pane_source_count_before_registration` | 1.660s |
