...
Generated 2026-08-02T05:25:12Z by the ci-metrics workflow. Do not edit —
...
|---|---|---:|---:|
| ci / check | clippy | 1m51s | 170 |
| ci / check | doc | 10s | 170 |
| ci / check | deny | 4s | 169 |
| ci / check | fmt | 2s | 174 |
| ci / test | unit | 12m46s | 156 |
| ci / test | e2e | 11s | 153 |
| ci / test | agents-smoke | 1s | 94 |
...
## Slowest tests (latest instrumented run, `a6b3e8086`)

| test | wall |
|---|---:|
| `phux-server::terminal_actor::tests::resize_desync_then_both_shrink_does_not_overflow` | 14.219s |
...
| `phux-record::golden_cast::both_containers_agree_on_the_frame_count_for_one_recording` | 2.227s |
