...
//!
//! Under [ADR-0013] pane content rides as raw VT bytes on the wire (the
//! hot path `PANE_OUTPUT` frame and the attach-time `PANE_SNAPSHOT` frame).
//! There is no structured cell-level diff codec in this crate.
//!
